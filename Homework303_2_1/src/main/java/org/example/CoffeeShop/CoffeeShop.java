...
public class CoffeeShop {
        ...
        public void initProducts() {
            ...
            cakePop.setPrice(5.46);
            cakePop.setname("Small Coffee");
            cakePop.setBeverage(true);
            products.add(CakePop);

            Product eggSandwich = new Product(price: 7.89, name: "Egg Sandwich", beverage: false);
