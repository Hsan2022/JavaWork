...
//necessary classes imported from the java standard library
import java.io.File; //for file in/output
import java.io.FileNotFoundException; //handling file not found exceptions
import java.util.Scanner; //for file in/output
import java.util.ArrayList; //for handling dynamic arrays
